...
The command \verb|\umat| automatically generates correct underlines on the coefficient or field quantity but avoids underlining superscripts. Examples in Ikeda's notation are
{\IkedaNotation
\begin{align}
