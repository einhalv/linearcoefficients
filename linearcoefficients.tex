...
we can write \verb|\renewcommand{\stiffnesssymbol}{C}|. This is how the standard notions are defined. As an example, the definition of \verb|\IkedaNotation| is
\begin{verbatim}
...
The pyroelectric cofficients are
\begin{align}
