...
Two notations are predefined: One mostly congruent with the definitions in the IEEE standard on piezoelectricity \cite{IEEEstd}. It is set with the command \verb|\IEEENotation| or by passing the option \verb|ieee| to the package. The other notation mostly follows Nye \cite{Nye}. Its command is \verb|\NyeNotation| and its option is \verb|nye|.
